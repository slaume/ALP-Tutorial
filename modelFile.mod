...
set METHODS; #{'exact','AF','acceptAll'}
set METHODSLP := METHODS diff {'acceptAll','exact'}; #only ALP method 
...
param thetaAFsim; #V_0 for affine VFA

var VAF {i in 1..I};
var thetaAF; #V_0 for affine VFA
var zAF {i in 1..I, A in 0..Amax};

#affine VFA (in the paper)
